...
const conversationController = {
    ...
    getDetail: async (req: Request, res: Response):  Promise<any> => {
        try {
            ...
            const conversationDetail = await conversationService.getDetail(user,entity);
    ...
    getPrivateRoomDetail: async (req: Request, res: Response):  Promise<any> => {
        try {
            const jwtPayload = req.user;
            ...
            let entity = result.data;
            const conversationDetail = await conversationService.getPrivateRoomDetail(user,entity);
